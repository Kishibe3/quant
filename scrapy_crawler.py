...
class FinstatSpider(scrapy.Spider):
    ...
    def __init__(self):
        self.stock = ['2330', '3167'] #pd.read_csv('raw data/stock code.csv')['代號'].to_list()
        # TODO check if raw data/stock code.csv exists or generate it
